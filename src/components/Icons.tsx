...
export const CpuChipIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m1.5-7.5V3m13.5 18v-1.5M19.5 12h1.5M19.5 8.25h1.5m-1.5 7.5h1.5m-7.5 3H9m6-3.75h-1.5m-6 0H9m6 0H9m6 3.75h-1.5M15 12h-1.5m-6 0H9m0 3.75h1.5m6-15v1.5" />
  </svg>
);
...
export const RocketLaunchIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.82m5.84-2.56a12.022 12.022 0 0 0-5.84 0m5.84 0a11.953 11.953 0 0 1 2.18 4.82m-8.02-4.82a12.022 12.022 0 0 1-5.84 0m5.84 0a11.953 11.953 0 0 0-2.18 4.82m8.02-4.82-2.18-4.82m0 0a6 6 0 0 0-5.84 0M9.71 9.55l-2.18-4.82m0 0a11.953 11.953 0 0 1 2.18-4.82m-2.18 4.82a12.022 12.022 0 0 0-5.84 0m5.84 0a11.953 11.953 0 0 1-2.18-4.82m2.18 4.82 2.18-4.82m0 0a6 6 0 0 1 5.84 0m-5.84 0a12.022 12.022 0 0 1 5.84 0m-5.84 0a11.953 11.953 0 0 0 2.18-4.82m-8.02 4.82 2.18-4.82m0 0a11.953 11.953 0 0 0-2.18-4.82m2.18 4.82a12.022 12.022 0 0 1 5.84 0m-5.84 0a11.953 11.953 0 0 1 2.18-4.82m-2.18 4.82-2.18-4.82m0 0a6 6 0 0 0-5.84 0m5.84 0a12.022 12.022 0 0 0-5.84 0" />
    </svg>
);
...
export const ChatBubbleOvalLeftEllipsisIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 9.75a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.53-.388m-5.168-3.32a9.76 9.76 0 0 1-.388-2.53C4.25 7.444 8.28 3.75 13.25 3.75c1.15 0 2.251.233 3.25.65M21 12a9.75 9.75 0 0 0-4.132-8.032M3 16.5a9.75 9.75 0 0 1 8.032-4.132" />
  </svg>
);
