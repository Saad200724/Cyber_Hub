...
// Fix: The API key must be obtained from process.env.API_KEY as per the guidelines. This also resolves the TypeScript error "Property 'env' does not exist on type 'ImportMeta'".
